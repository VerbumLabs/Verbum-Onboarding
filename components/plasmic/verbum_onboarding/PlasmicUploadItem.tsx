                  ...
                  >
                    ...
                    >
                      <AntdSelect
                        ...
                        options={(() => {
                          const __composite = [
                            { type: "option", label: null },
                            { type: "option", label: null },
                            { type: "option", label: null },
                            { type: "option", label: null }
                          ];
                          __composite["0"]["label"] = "2.5%";
                          __composite["1"]["label"] = "5%";
                          __composite["2"]["label"] = "7.5%";
                          __composite["3"]["label"] = "10%";
                          return __composite;
                        })()}
                        placeholder={"Select..."}
                        popupScopeClassName={sty["select__fvYza__popup"]}
                      />
                    </FormItemWrapper>
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__h6Ox8
                      )}
                      label={"Description"}
                      name={"message"}
                      rules={[{ ruleType: "required" }]}
                    ...
                    >
                      <AntdSelect
                        ...
                        options={(() => {
                          ...
                          __composite["0"]["label"] = "New";
                          __composite["1"]["label"] = "Very Good";
                          __composite["2"]["label"] = "Good";
                          __composite["3"]["label"] = "Fair";
                          return __composite;
                        })()}
                        placeholder={"Select..."}
                        popupScopeClassName={sty["select__knZpK__popup"]}
                      />
                    </FormItemWrapper>
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__oh7Fv
                      )}
                    ...
                    >
                      <AntdSelect
                        ...
                        placeholder={"Select..."}
                        popupScopeClassName={sty["select__yhIlJ__popup"]}
                      />
                    </FormItemWrapper>
                    <AntdButton
                      className={classNames(
